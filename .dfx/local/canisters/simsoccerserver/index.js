...
import { idlFactory } from './simsoccerserver.did.js';
export { idlFactory } from './simsoccerserver.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.SIMSOCCERSERVER_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./simsoccerserver.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the simsoccerserver canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./simsoccerserver.did.js")._SERVICE>}
 */
